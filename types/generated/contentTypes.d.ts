...
export interface ApiBoardBoard extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    boardtype: Schema.Attribute.Enumeration<
      [
        'verify',
        'onca',
        'offca',
...
export interface ApiCommentComment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    parents: Schema.Attribute.Relation<'oneToMany', 'api::comment.comment'>;
...
export interface ApiPointHistoryPointHistory
  extends Struct.CollectionTypeSchema {
  collectionName: 'point_histories';
  info: {
    displayName: 'PointHistory';
    pluralName: 'point-histories';
    singularName: 'point-history';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::point-history.point-history'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    type: Schema.Attribute.Enumeration<
      ['post', 'comment', 'attendance', 'admin', 'levelup']
    > &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dislikes: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    importance: Schema.Attribute.Enumeration<['normal', 'important', 'event']>;
    isNotice: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    ...
    users_permissions_user: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    uservotes: Schema.Attribute.Relation<'oneToOne', 'api::vote.vote'>;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    attendances: Schema.Attribute.Relation<
      ...
      'api::attendance.attendance'
    >;
    attendanceStreak: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    ...
    lastAttendance: Schema.Attribute.DateTime;
    ...
    point_histories: Schema.Attribute.Relation<
      'oneToMany',
      'api::point-history.point-history'
    >;
    points: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<1000>;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::point-history.point-history': ApiPointHistoryPointHistory;
